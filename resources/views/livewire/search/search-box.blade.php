<div x-data="{
    ...
    <div>
        <h3 class="text-lg font-semibold text-gray-900 mb-3">Filtre sua busca</h3>
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            <input x-model="query"
                ...
                type="text" placeholder="Pesquisar" wire:model="search">
        </div>
        <x-button x-on:click="$dispatch('search',{search: query})">Buscar</x-button>
    </div>
</div>
